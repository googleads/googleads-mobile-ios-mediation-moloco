...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "MolocoAdapter",
      url:
        "https://dl.google.com/googleadmobadssdk/mediation/ios/Moloco/MolocoAdapter-4.9.0.0.zip",
      checksum: "081100011405cebcd7a65ccb7ce874fbdbaca071ca0e53e7e94b1f09fef371c4"
    ),
  ]
)
